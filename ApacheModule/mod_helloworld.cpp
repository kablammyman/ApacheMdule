...
//when done, completed linux modules go here: /usr/lib/apache2/modules/yourMod.so
//when done, completed windows modules go here: C:\wamp64\bin\apache\apache2.4.18\modules\yourMod.dll
//seems that windows can use .so files too...
